...
6. Since `player_data.db` is excluded from this repository, you'll need to manually create the database and its three tables before running the game. Each table needs the following columns:
